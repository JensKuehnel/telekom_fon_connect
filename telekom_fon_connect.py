...
def reset_http_debug_out(http_log):
    ...
    # Remove \r in Log, remove the byte prefix - is already a string with b
    # and no byte tyoe in http_log.content list, replace \n to be printed as
    # newline and remove lines with only ' in
    debug_info = ''.join(
